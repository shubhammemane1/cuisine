...
final Cuisine_data = [
  Cuisine(
    id: 'c1',
    name: "Indian",
    img: "gs://testing-6a320.appspot.com/cuisine/indianfood.jpg",
  ),
  Cuisine(
    id: 'c2',
    name: "Chinese",
    img: "gs://testing-6a320.appspot.com/cuisine/chinese.jpg",
  ),
  Cuisine(
    id: 'c3',
    name: "Thai",
    img: "gs://testing-6a320.appspot.com/cuisine/thai.png",
  ),
  Cuisine(
    id: 'c4',
    name: "Maharastrian",
    img: "gs://testing-6a320.appspot.com/cuisine/puranpoli.jpg",
  ),
  Cuisine(
    id: 'c5',
    name: "Punjabi",
    img: "gs://testing-6a320.appspot.com/cuisine/punjabi.jpg",
  ),
  Cuisine(
    id: 'c6',
    name: "South Indian",
    img: "gs://testing-6a320.appspot.com/cuisine/southindian.jpeg",
  ),
  Cuisine(
    id: 'c7',
    name: "Rajasthani",
  ...
  Cuisine(
    id: 'c9', // he id hya vrn
    name: "Fast Food",
    img: "gs://testing-6a320.appspot.com/cuisine/fastfood.jpg",
  ),
];

// Cuisine vala data aahe na to sort jhala oahije cuisine dishes cha id vrn

final Cuisine_Dishes = [
  Dishes(
    id: 'm1',
    name: "Misal Pav",
    time: '45 mins',
  ...
  Dishes(
    ...
    recipe: [
      ...
      'Using a medium to large grater (the kind you would use for cabbage salad), grate the flesh of the mangoes into a mixing bowl. Keep in mind there is a large flat stone at the mangos center.',
    ...
    img: 'gs://testing-6a320.appspot.com/cuisine/salad.webp',
    favourite: false,
  ),
  Dishes(
    id: "m10",
    ...
    ingredients: [
      ...
      '1 tsp Pepper',
      '1 tbsp Soya sauce',
      '4 tbsp Cornflour - mixed with1 cup Water',
      '2 stems Spring onion as required oil & salt'
    ],
    recipe: [
    ...
    img: 'gs://testing-6a320.appspot.com/cuisine/soup.webp',
    favourite: false,
  ),
  Dishes(
    id: "m11",
    ...
    img: 'gs://testing-6a320.appspot.com/cuisine/butter.jpg',
    favourite: false,
  )
];
// Dishes(id:"",
